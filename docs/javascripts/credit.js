document.addEventListener("DOMContentLoaded", function () {
  ...
  wrapper.className = "md-header__credit";

  var text = document.createElement("span");
  text.className = "md-header__credit-text";
  text.textContent = "Designed & maintained by Rajkumar";

  var link = document.createElement("a");
  link.href = "https://www.linkedin.com/in/raj-k-859ba04b/";
  link.target = "_blank";
  link.rel = "noopener noreferrer";
  link.className = "md-header__linkedin";
